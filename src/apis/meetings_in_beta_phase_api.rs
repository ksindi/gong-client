...
pub async fn add_meeting(configuration: &configuration::Configuration, new_meeting_request: crate::models::NewMeetingRequest) -> Result<crate::models::NewMeetingResponse, Error<AddMeetingError>> {
...
pub async fn delete_meeting(configuration: &configuration::Configuration, meeting_id: i64, delete_meeting_request: crate::models::DeleteMeetingRequest) -> Result<crate::models::DeleteMeetingRequest, Error<DeleteMeetingError>> {
    let local_var_configuration = configuration;
...
pub async fn integration_status(configuration: &configuration::Configuration, integration_status_request: crate::models::IntegrationStatusRequest) -> Result<crate::models::IntegrationStatusResponse, Error<IntegrationStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn update_meeting(configuration: &configuration::Configuration, meeting_id: i64, update_meeting_request: crate::models::UpdateMeetingRequest) -> Result<crate::models::UpdateMeetingResponse, Error<UpdateMeetingError>> {
    let local_var_configuration = configuration;
