...
pub async fn list_logs(configuration: &configuration::Configuration, log_type: &str, from_date_time: &str, to_date_time: Option<&str>, cursor: Option<&str>) -> Result<crate::models::LogsResponse, Error<ListLogsError>> {
