...
pub async fn find_all_references_to_email_address(configuration: &configuration::Configuration, email_address: &str) -> Result<crate::models::EmailAddressReferences, Error<FindAllReferencesToEmailAddressError>> {
...
pub async fn find_all_references_to_phone_number(configuration: &configuration::Configuration, phone_number: &str) -> Result<crate::models::PhoneNumberReferences, Error<FindAllReferencesToPhoneNumberError>> {
    let local_var_configuration = configuration;
...
pub async fn purge_email_address(configuration: &configuration::Configuration, email_address: &str) -> Result<crate::models::BaseResponse, Error<PurgeEmailAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn purge_phone_number(configuration: &configuration::Configuration, phone_number: &str) -> Result<crate::models::BaseResponse, Error<PurgePhoneNumberError>> {
    let local_var_configuration = configuration;
