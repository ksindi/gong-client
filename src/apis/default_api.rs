...
/// struct for typed errors of method [`delete_generic_crm_integration_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteGenericCrmIntegrationDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_crm_objects_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCrmObjectsDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`list_crm_schema_fields_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListCrmSchemaFieldsDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`list_generic_crm_integration_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListGenericCrmIntegrationDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`map_crm_users`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MapCrmUsersError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`register_generic_crm_integration_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RegisterGenericCrmIntegrationDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`upload_crm_data_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UploadCrmDataDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`upload_crm_schema_field_deprecated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UploadCrmSchemaFieldDeprecatedError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`upload_stages`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UploadStagesError {
    UnknownValue(serde_json::Value),
}

pub async fn delete_generic_crm_integration_deprecated(
    configuration: &configuration::Configuration,
    integration_id: i64,
    client_request_id: &str,
) -> Result<crate::models::BaseResponse, Error<DeleteGenericCrmIntegrationDeprecatedError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("integrationId", &integration_id.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("clientRequestId", &client_request_id.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteGenericCrmIntegrationDeprecatedError> =
...
pub async fn get_crm_objects_deprecated(
    configuration: &configuration::Configuration,
    integration_id: i64,
    object_type: &str,
    objects_crm_ids: Vec<String>,
) -> Result<crate::models::BaseResponse, Error<GetCrmObjectsDeprecatedError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/crm/object/list", local_var_configuration.base_path);
    let mut local_var_req_builder =
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("integrationId", &integration_id.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("objectType", &object_type.to_string())]);
    local_var_req_builder = match "csv" {
        "multi" => local_var_req_builder.query(
            &objects_crm_ids
                .into_iter()
                .map(|p| ("objectsCrmIds".to_owned(), p.to_string()))
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCrmObjectsDeprecatedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_crm_schema_fields_deprecated(
    configuration: &configuration::Configuration,
    integration_id: i64,
    object_type: &str,
) -> Result<crate::models::BaseResponse, Error<ListCrmSchemaFieldsDeprecatedError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListCrmSchemaFieldsDeprecatedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_generic_crm_integration_deprecated(
    configuration: &configuration::Configuration,
) -> Result<crate::models::BaseResponse, Error<ListGenericCrmIntegrationDeprecatedError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListGenericCrmIntegrationDeprecatedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn map_crm_users(
    configuration: &configuration::Configuration,
    client_request_id: &str,
    integration_id: i64,
) -> Result<crate::models::BaseResponse, Error<MapCrmUsersError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/crm/map/users", local_var_configuration.base_path);
    let mut local_var_req_builder =
    ...
    // TODO: support file upload for 'dataFile' parameter
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MapCrmUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn register_generic_crm_integration_deprecated(
    configuration: &configuration::Configuration,
    generic_crm_registration_request: crate::models::GenericCrmRegistrationRequest,
) -> Result<crate::models::BaseResponse, Error<RegisterGenericCrmIntegrationDeprecatedError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RegisterGenericCrmIntegrationDeprecatedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_crm_data_deprecated(
    configuration: &configuration::Configuration,
    client_request_id: &str,
    integration_id: i64,
    object_type: &str,
) -> Result<crate::models::BaseResponse, Error<UploadCrmDataDeprecatedError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadCrmDataDeprecatedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_crm_schema_field_deprecated(
    configuration: &configuration::Configuration,
    integration_id: i64,
    object_type: &str,
    generic_schema_field_request_deprecated: Vec<
        crate::models::GenericSchemaFieldRequestDeprecated,
    >,
) -> Result<crate::models::BaseResponse, Error<UploadCrmSchemaFieldDeprecatedError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/crm/object/schema", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&generic_schema_field_request_deprecated);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadCrmSchemaFieldDeprecatedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_stages(
    configuration: &configuration::Configuration,
    integration_id: i64,
    generic_deal_stage_request: Vec<crate::models::GenericDealStageRequest>,
) -> Result<crate::models::BaseResponse, Error<UploadStagesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/crm/stages", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&generic_deal_stage_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadStagesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
