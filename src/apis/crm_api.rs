...
/// struct for typed errors of method [`upload_crm_data`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UploadCrmDataError {
    Status400(crate::models::ErrorResponse),
    Status401(crate::models::ErrorResponse),
    Status409(crate::models::ErrorResponse),
    Status429(crate::models::ErrorResponse),
...
pub async fn delete_generic_crm_integration(
    configuration: &configuration::Configuration,
    integration_id: i64,
    client_request_id: &str,
) -> Result<crate::models::AsyncProcessingResponse, Error<DeleteGenericCrmIntegrationError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteGenericCrmIntegrationError> =
...
pub async fn get_crm_objects(
    configuration: &configuration::Configuration,
    integration_id: i64,
    object_type: &str,
    objects_crm_ids: Vec<String>,
) -> Result<crate::models::GetGenericCrmObjectsResponse, Error<GetCrmObjectsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCrmObjectsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_request_status(
    ...
    integration_id: i64,
    client_request_id: &str,
) -> Result<crate::models::RequestStatusResponse, Error<GetRequestStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRequestStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_crm_schema_fields(
    configuration: &configuration::Configuration,
    integration_id: i64,
    object_type: &str,
) -> Result<crate::models::ListSelectedFieldsResponse, Error<ListCrmSchemaFieldsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListCrmSchemaFieldsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_generic_crm_integration(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListGenericCrmIntegrationsResponse, Error<ListGenericCrmIntegrationError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListGenericCrmIntegrationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn register_generic_crm_integration(
    configuration: &configuration::Configuration,
    generic_crm_registration_request: crate::models::GenericCrmRegistrationRequest,
) -> Result<crate::models::RegisterGenericCrmResponse, Error<RegisterGenericCrmIntegrationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RegisterGenericCrmIntegrationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_crm_data(
    configuration: &configuration::Configuration,
) -> Result<crate::models::AsyncProcessingResponse, Error<UploadCrmDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadCrmDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_crm_schema_field(
    configuration: &configuration::Configuration,
    integration_id: i64,
    object_type: &str,
    generic_schema_field_request: Vec<crate::models::GenericSchemaFieldRequest>,
) -> Result<crate::models::BaseResponse, Error<UploadCrmSchemaFieldError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadCrmSchemaFieldError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
