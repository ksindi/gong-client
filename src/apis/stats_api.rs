...
pub async fn list_answered_scorecards(configuration: &configuration::Configuration, public_api_base_request_v2_answered_scorecards_filter: crate::models::PublicApiBaseRequestV2AnsweredScorecardsFilter) -> Result<crate::models::AnsweredScorecards, Error<ListAnsweredScorecardsError>> {
...
pub async fn list_interaction_stats(configuration: &configuration::Configuration, public_api_base_request_v2_multiple_users_with_dates: crate::models::PublicApiBaseRequestV2MultipleUsersWithDates) -> Result<crate::models::CompanyUsersIntercationStatsResponse, Error<ListInteractionStatsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_multiple_users_aggregate_activity(configuration: &configuration::Configuration, public_api_base_request_v2_multiple_users_with_dates: crate::models::PublicApiBaseRequestV2MultipleUsersWithDates) -> Result<crate::models::CompanyUsersAggregateActivityResponse, Error<ListMultipleUsersAggregateActivityError>> {
    let local_var_configuration = configuration;
...
pub async fn list_multiple_users_aggregate_by_period(configuration: &configuration::Configuration, request_with_time_period: crate::models::RequestWithTimePeriod) -> Result<crate::models::UsersAggregateByPeriodActivity, Error<ListMultipleUsersAggregateByPeriodError>> {
    let local_var_configuration = configuration;
...
pub async fn list_multiple_users_day_by_day_activity(configuration: &configuration::Configuration, public_api_base_request_v2_multiple_users_with_dates: crate::models::PublicApiBaseRequestV2MultipleUsersWithDates) -> Result<crate::models::UsersDayByDayActivity, Error<ListMultipleUsersDayByDayActivityError>> {
    let local_var_configuration = configuration;
