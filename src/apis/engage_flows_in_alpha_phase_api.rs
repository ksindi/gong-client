...
pub async fn assign_prospects(configuration: &configuration::Configuration, assign_flow_request_v2: crate::models::AssignFlowRequestV2) -> Result<crate::models::AssignFlowResponse, Error<AssignProspectsError>> {
...
pub async fn get_flows_for_prospects(configuration: &configuration::Configuration, prospects_assigned_flows_request_v2: crate::models::ProspectsAssignedFlowsRequestV2) -> Result<crate::models::ProspectsFlowsResponse, Error<GetFlowsForProspectsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_flows(configuration: &configuration::Configuration, flow_owner_email: &str, cursor: Option<&str>, workspace_id: Option<&str>) -> Result<crate::models::FlowsResponse, Error<ListFlowsError>> {
    let local_var_configuration = configuration;
