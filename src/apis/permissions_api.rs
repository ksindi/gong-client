...
pub async fn add_users_access_to_calls(configuration: &configuration::Configuration, calls_users_access_add_dto: crate::models::CallsUsersAccessAddDto) -> Result<crate::models::BaseResponse, Error<AddUsersAccessToCallsError>> {
...
pub async fn create_permission_profile(configuration: &configuration::Configuration, workspace_id: &str, permission_profile_dto: crate::models::PermissionProfileDto) -> Result<crate::models::PermissionProfileResponse, Error<CreatePermissionProfileError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_users_access_to_calls(configuration: &configuration::Configuration, calls_users_access_delete_dto: crate::models::CallsUsersAccessDeleteDto) -> Result<crate::models::BaseResponse, Error<DeleteUsersAccessToCallsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_permission_profile(configuration: &configuration::Configuration, profile_id: &str) -> Result<crate::models::PermissionProfileResponse, Error<GetPermissionProfileError>> {
    let local_var_configuration = configuration;
...
pub async fn get_users_access_to_calls(configuration: &configuration::Configuration, filter_request_calls_access_get_dto: crate::models::FilterRequestCallsAccessGetDto) -> Result<crate::models::CallsAccessDetailsResponse, Error<GetUsersAccessToCallsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_permission_profile(configuration: &configuration::Configuration, workspace_id: &str) -> Result<crate::models::PermissionProfilesResponse, Error<ListPermissionProfileError>> {
    let local_var_configuration = configuration;
...
pub async fn list_permission_profile_users(configuration: &configuration::Configuration, profile_id: &str) -> Result<crate::models::PermissionProfileUsersResponse, Error<ListPermissionProfileUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn update_permission_profile(configuration: &configuration::Configuration, profile_id: &str, permission_profile_dto: crate::models::PermissionProfileDto) -> Result<crate::models::PermissionProfileResponse, Error<UpdatePermissionProfileError>> {
    let local_var_configuration = configuration;
