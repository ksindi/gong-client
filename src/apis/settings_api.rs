...
pub async fn list_scorecards(configuration: &configuration::Configuration, ) -> Result<crate::models::Scorecards, Error<ListScorecardsError>> {
...
pub async fn list_trackers(configuration: &configuration::Configuration, workspace_id: Option<&str>) -> Result<crate::models::Trackers, Error<ListTrackersError>> {
    let local_var_configuration = configuration;
...
pub async fn list_workspaces(configuration: &configuration::Configuration, ) -> Result<crate::models::WorkspacesMetadata, Error<ListWorkspacesError>> {
    let local_var_configuration = configuration;
