...
pub async fn get_calls_in_specific_folder(configuration: &configuration::Configuration, folder_id: Option<&str>) -> Result<crate::models::LibraryFolderListOfCallsResponse, Error<GetCallsInSpecificFolderError>> {
...
pub async fn get_library_structure(configuration: &configuration::Configuration, workspace_id: Option<&str>) -> Result<crate::models::LibraryResponse, Error<GetLibraryStructureError>> {
    let local_var_configuration = configuration;
