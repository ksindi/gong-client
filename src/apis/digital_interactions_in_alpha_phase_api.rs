...
pub async fn add_digital_interaction(configuration: &configuration::Configuration, digital_interaction_request: crate::models::DigitalInteractionRequest) -> Result<crate::models::RegisterGenericCrmResponse, Error<AddDigitalInteractionError>> {
