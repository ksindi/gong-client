...
pub async fn content_shared(configuration: &configuration::Configuration, content_shared_event: crate::models::ContentSharedEvent) -> Result<crate::models::RegisterGenericCrmResponse, Error<ContentSharedError>> {
...
pub async fn content_viewed(configuration: &configuration::Configuration, content_viewed_event: crate::models::ContentViewedEvent) -> Result<crate::models::RegisterGenericCrmResponse, Error<ContentViewedError>> {
    let local_var_configuration = configuration;
...
pub async fn custom_action(configuration: &configuration::Configuration, custom_action_event: crate::models::CustomActionEvent) -> Result<crate::models::RegisterGenericCrmResponse, Error<CustomActionError>> {
    let local_var_configuration = configuration;
