...
pub struct PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<crate::models::MultipleUsersRequestWithCreationDates>,
}

impl PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
    pub fn new(filter: crate::models::MultipleUsersRequestWithCreationDates) -> PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
