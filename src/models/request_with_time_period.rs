...
pub struct RequestWithTimePeriod {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<crate::models::MultipleUsersWithDates>,
...
impl RequestWithTimePeriod {
    pub fn new(filter: crate::models::MultipleUsersWithDates, aggregation_period: AggregationPeriod) -> RequestWithTimePeriod {
