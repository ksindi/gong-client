...
pub struct AssignFlowRequestV2 {
    /// The CRM IDs of the contact or lead that should be assigned to a Gong Engage flow
    #[serde(rename = "crmProspectsIds")]
    pub crm_prospects_ids: Vec<String>,
    /// The Gong Engage Flow ID to assign the contact to.
    #[serde(rename = "flowId")]
    pub flow_id: String,
    /// The email of the Gong user who will own the flow tasks.
