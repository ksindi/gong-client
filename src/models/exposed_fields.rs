...
pub struct ExposedFields {
    ...
    pub content: Option<Box<crate::models::CallContent>>,
    #[serde(rename = "interaction", skip_serializing_if = "Option::is_none")]
    pub interaction: Option<Box<crate::models::CallInteraction>>,
    #[serde(rename = "collaboration", skip_serializing_if = "Option::is_none")]
    pub collaboration: Option<Box<crate::models::CallCollaboration>>,
