...
pub struct DigitalInteractionRequest {
    ...
    #[serde(rename = "person")]
    pub person: Box<crate::models::Person>,
...
impl DigitalInteractionRequest {
    ...
    pub fn new(event_id: String, timestamp: String, event_type: String, content: crate::models::Content, person: crate::models::Person) -> DigitalInteractionRequest {
