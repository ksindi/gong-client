...
pub struct ForecastPermissions {
    ...
    pub forecast_access: Option<Box<crate::models::ForecastAccess>>,
    #[serde(rename = "forecastEditSubmissions", skip_serializing_if = "Option::is_none")]
    pub forecast_edit_submissions: Option<Box<crate::models::ForecastEditSubmissions>>,
    #[serde(rename = "forecastEditTargets", skip_serializing_if = "Option::is_none")]
    pub forecast_edit_targets: Option<Box<crate::models::ForecastEditTargets>>,
}
