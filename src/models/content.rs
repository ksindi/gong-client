...
pub struct Content {
    ...
    pub numeric_content_details: Option<Box<crate::models::NumericContentDetails>>,
    #[serde(rename = "stepContentDetails", skip_serializing_if = "Option::is_none")]
    pub step_content_details: Option<Box<crate::models::StepContentDetails>>,
    #[serde(rename = "searchObjectDetails", skip_serializing_if = "Option::is_none")]
    pub search_object_details: Option<Box<crate::models::SearchObjectDetails>>,
    /// Include additional custom data about the content
    #[serde(rename = "contentCustomFields", skip_serializing_if = "Option::is_none")]
    pub content_custom_fields: Option<Vec<crate::models::CustomField>>,
}
