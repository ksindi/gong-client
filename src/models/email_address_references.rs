...
pub struct EmailAddressReferences {
    ...
    pub emails: Option<Vec<crate::models::EmailMessage>>,
    /// Related calls.
    #[serde(rename = "calls", skip_serializing_if = "Option::is_none")]
    pub calls: Option<Vec<crate::models::CallReference>>,
    /// Related meetings.
    #[serde(rename = "meetings", skip_serializing_if = "Option::is_none")]
    pub meetings: Option<Vec<crate::models::Meeting>>,
    ...
    pub customer_data: Option<Vec<crate::models::CustomerData>>,
    ...
    pub customer_engagement: Option<Vec<crate::models::CustomerEngagement>>,
}
