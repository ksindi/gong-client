...
pub struct PublicApiBaseRequestV2AnsweredScorecardsFilter {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<crate::models::AnsweredScorecardsFilter>,
}

impl PublicApiBaseRequestV2AnsweredScorecardsFilter {
    pub fn new(filter: crate::models::AnsweredScorecardsFilter) -> PublicApiBaseRequestV2AnsweredScorecardsFilter {
