...
pub struct GenericSchemaFieldRequestDeprecated {
...
impl GenericSchemaFieldRequestDeprecated {
    pub fn new(unique_name: String, label: String, r#type: Type) -> GenericSchemaFieldRequestDeprecated {
