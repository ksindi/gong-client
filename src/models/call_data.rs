...
pub struct CallData {
    ...
    pub meta_data: Option<Box<crate::models::CallBasicData>>,
    /// A list of the agenda of each part of the call.
    #[serde(rename = "context", skip_serializing_if = "Option::is_none")]
    pub context: Option<Vec<crate::models::CallContextDto>>,
    /// A list of the call's participants
    #[serde(rename = "parties", skip_serializing_if = "Option::is_none")]
    pub parties: Option<Vec<crate::models::Party>>,
    #[serde(rename = "content", skip_serializing_if = "Option::is_none")]
    pub content: Option<Box<crate::models::ContentDto>>,
    #[serde(rename = "interaction", skip_serializing_if = "Option::is_none")]
    pub interaction: Option<Box<crate::models::InteractionMeasuresDto>>,
    #[serde(rename = "collaboration", skip_serializing_if = "Option::is_none")]
    pub collaboration: Option<Box<crate::models::CollaborationDto>>,
    #[serde(rename = "media", skip_serializing_if = "Option::is_none")]
    pub media: Option<Box<crate::models::MediaDto>>,
}
