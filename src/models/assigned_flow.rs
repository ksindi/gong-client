...
pub struct AssignedFlow {
    ...
    /// The creation date of the flow instance in the ISO-8601 format (e.g., '2018-02-18T02:30:00-07:00' or '2018-02-18T08:00:00Z', where Z stands for UTC).
