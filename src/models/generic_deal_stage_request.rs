...
pub struct GenericDealStageRequest {
...
impl GenericDealStageRequest {
    pub fn new(internal_name: String, name: String, is_active: bool, sort_order: i32) -> GenericDealStageRequest {
