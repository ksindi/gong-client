...
pub struct ContentDto {
    ...
    pub structure: Option<Vec<crate::models::StructureDto>>,
    #[serde(rename = "trackers", skip_serializing_if = "Option::is_none")]
    pub trackers: Option<Vec<crate::models::TrackerDto>>,
    #[serde(rename = "topics", skip_serializing_if = "Option::is_none")]
    pub topics: Option<Vec<crate::models::TopicDto>>,
    #[serde(rename = "scorecardsAnswers", skip_serializing_if = "Option::is_none")]
    pub scorecards_answers: Option<Vec<crate::models::ScorecardAnswerDto>>,
    #[serde(rename = "pointsOfInterest", skip_serializing_if = "Option::is_none")]
    pub points_of_interest: Option<Box<crate::models::PointsOfInterest>>,
}
