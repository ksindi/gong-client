...
pub struct UpdateMeetingRequest {
    ...
    pub invitees: Vec<crate::models::MeetingInvitee>,
...
impl UpdateMeetingRequest {
    ...
    pub fn new(start_time: String, end_time: String, invitees: Vec<crate::models::MeetingInvitee>, organizer_email: String) -> UpdateMeetingRequest {
