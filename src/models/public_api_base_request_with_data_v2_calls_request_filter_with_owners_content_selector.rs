...
pub struct PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<crate::models::CallsRequestFilterWithOwners>,
    #[serde(rename = "contentSelector", skip_serializing_if = "Option::is_none")]
    pub content_selector: Option<Box<crate::models::ContentSelector>>,
}

impl PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
    pub fn new(filter: crate::models::CallsRequestFilterWithOwners) -> PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
